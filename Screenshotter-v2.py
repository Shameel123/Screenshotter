...
while(1)
{
if(-not(Test-Path C:\SS\)) #checks if the folder doesn't exist so it creates one
{
 New-Item -ItemType Directory -Path "C:\SS\"  #creates directory according to date's name.
}
...
$date = "$day" + "-" + "$month" + "-" + "$year" + "___" + "$hour" + "-"+ "$minute" + "__"+"$env:COMPUTERNAME"+".jpg"

Take-ScreenShot -screen -file "C:\SS\$date" -imagetype jpeg 
